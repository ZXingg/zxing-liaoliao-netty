...
public class UserController {
    ...
    public IMoocJSONResult registOrLogin(@RequestBody Users user) throws Exception {
        ...
        if (usernameIsExist) {
            ...
            user.setFaceImage("M00/00/00/default.png");
            user.setFaceImageBig("M00/00/00/default_big.png");
    ...
    public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
        ...
        String userFacePath = imageProperties.getUserfacePath() + userBO.getUserId() + "userface64.png";
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
    ...
    public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
        ...
        // 查询列表
        List<com.zxing.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
